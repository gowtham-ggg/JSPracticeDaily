...
// Output: 10 (fn is executed after 20ms, cancelFn is invoked after 50ms)

const fn1 = (x) => console.log(x ** 2);
const args1 = [2];
const t1 = 100;

const cancelTimeMs1 = 50;
const cancelFn1 = cancellable(fn, args, t);
setTimeout(cancelFn1, cancelTimeMs1);

// Output: (No output; fn is canceled before execution)
